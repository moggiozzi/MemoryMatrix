...
{
  // !!! ќ—“џЋ№!!! оконное приложение не корректно определ€ет размер канваса http://stackoverflow.com/questions/13403853/glut-wrong-mouse-coordinates
...
void initGlut(int argc, char* argv[]){
  ...
  glutSpecialFunc( handleInput ); // дл€ обработки спец клавиш (стрелки в том числе)
